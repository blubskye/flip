...
private:
	void StartChannelInsert(const int localidentityid, const std::string &channel, const std::string &message, const int &eventtype);
	void StartTopicInsert(const int localidentityid, const std::string &channel, const std::string &topic);
	// H1-compat: legacycompat=true selects PKCS#1 v1.5 padding for pre-H1 FLIP peers.
	void StartPrivateInsert(const int localidentityid, const int recipientidentityid, const std::string &message, const int &eventtype, const bool legacycompat=false);
	...
	void StartKeepAliveInsert(const int localidentityid, const std::string &nick, std::string &channels);
	void StartNickChangeInsert(const int localidentityid, const std::string &nick);
