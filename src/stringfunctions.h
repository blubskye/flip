...
/**
	\brief unescapes the supplied string
	\param str string that is escaped
	\param escapechar character that is used to escape the next char in the supplied string
	\param literalchars vector of characters to find after escape character.  Must have same number of elements as replacechars
	\param replacechars vector of characters to replace the escape sequence with.  Must have same number of elements as literalchars
	\return unescaped string
*/
std::string UnEscape(const std::string &str, const char escapechar, const std::vector<char> literalchars, const std::vector<char> replacechars);
